...
parser.add_argument(
    "--path",
    type=str,
    default=["fid_stats_celeba64.npz", "../saved_info/celeba_256/celeba_dgan/generated_samples"],
    ...
    if path.endswith(".npz") or path.endswith(".npy"):
        ...
        try:
            ...
            try:
                ...
                raise ValueError("The 'mu' and 'sigma' keys are missing or inaccessible.") from None
